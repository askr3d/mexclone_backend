...
@section('content')
    <main class="d-flex flex-column align-items-end container" style="gap: 2rem">
        ...
        <div class="w-100">
            <table id="tablaCiudades" class="display">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nombre</th>
...
<script>
    ...
    const data = {!! json_encode($ciudades) !!};



    const tablaCiudades = new DataTable("#tablaCiudades", {
        data,
        columns: [
            { data: 'id' },
            { data: 'nombre' },
            ...
            { data: 'created_at' },
            {
                ...
                render: (data, type, row) => {
                    let ruta = "{{ route('admin.ciudades.edit', 'sustituir' ) }}";
        ...
        Swal.fire({
            ...
            confirmButtonText: "SI, eliminar"
                ...
                if (result.isConfirmed) {
                    let ruta = "{{ route('admin.ciudades.destroy', 'sustituir' ) }}";
