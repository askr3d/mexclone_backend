...
@section('content')
    <main class="d-flex flex-column align-items-end container" style="gap: 2rem">
        <div>
            <a
                href="{{ route('admin.paises.create') }}"
        ...
        <div class="w-100">
            <table id="tablaPaises" class="display">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nombre</th>
...
<script>
    ...
    const tablaPaises = new DataTable("#tablaPaises", {
        data,
        columns: [
            { data: 'id' },
            { data: 'nombre' },
            { data: 'created_at' },
            {
                ...
                render: (data, type, row) => {
                    let ruta = "{{ route('admin.paises.edit', 'sustituir' ) }}";
        ...
        Swal.fire({
            ...
            confirmButtonText: "SI, eliminar"
                ...
                if (result.isConfirmed) {
                    let ruta = "{{ route('admin.paises.destroy', 'sustituir' ) }}";
