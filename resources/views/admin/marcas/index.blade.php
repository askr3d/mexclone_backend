...
@section('content')
    <main class="d-flex flex-column align-items-end container" style="gap: 2rem">
        ...
        <div class="w-100">
            <table id="tablaMarcas" class="display">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nombre</th>
...
<script>
    ...
    const data = {!! json_encode($marcas) !!};



    const tablaMarcas = new DataTable("#tablaMarcas", {
        data,
        columns: [
            { data: 'id' },
            { data: 'nombre' },
            { data: 'created_at' },
            {
                ...
                render: (data, type, row) => {
                    let ruta = "{{ route('admin.marcas.edit', 'sustituir' ) }}";
        ...
        Swal.fire({
            ...
            confirmButtonText: "SI, eliminar"
                ...
                if (result.isConfirmed) {
                    let ruta = "{{ route('admin.marcas.destroy', 'sustituir' ) }}";
